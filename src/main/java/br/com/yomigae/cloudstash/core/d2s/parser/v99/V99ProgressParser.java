...
import br.com.yomigae.cloudstash.core.d2s.model.progress.*;
import br.com.yomigae.cloudstash.core.d2s.model.D2S;
import br.com.yomigae.cloudstash.core.d2s.parser.ProgressParser;
...
public class V99ProgressParser implements ProgressParser {

    @Override
    public Map<Difficulty, D2S.Progress> parse(D2BinaryReader reader) {
        Map<Difficulty, D2S.Progress.Builder> all = toEnumMap(
                Difficulty.class,
                Difficulty.all(),
                D2S.Progress::builder);

        reader.find("Woo!".getBytes()).skipBytes(10);
        for (Difficulty difficulty : Difficulty.all()) {
            D2S.Progress.Builder acts = all.get(difficulty);
            acts.act1()
                    .visited(true)
                    .introduced(reader.readShort() > 0)
                    .quests(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act1.Quests.builder()
            ...
            acts.act2()
                    ...
                    .introduced(reader.readShort() > 0)
                    .quests(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act2.Quests.builder()
            ...
            acts.act3()
                    .visited(reader.readShort() > 0)
                    .introduced(reader.readShort() > 0)
                    .quests(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act3.Quests.builder()
            ...
            acts.act4()
                    .visited(reader.readShort() > 0)
                    .introduced(reader.readShort() > 0)
                    .quests(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act4.Quests.builder()
            ...
            acts.act5()
                    ...
                    .quests(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act5.Quests.builder()
        ...
        for (Difficulty difficulty : Difficulty.all()) {
            ...
            acts.act1().waypoints(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act1.Waypoints.builder()
                    ...
                    .build());
            acts.act2().waypoints(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act2.Waypoints.builder()
                    ...
                    .build());
            acts.act3().waypoints(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act3.Waypoints.builder()
                    ...
                    .build());
            acts.act4().waypoints(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act4.Waypoints.builder()
                    .thePandemoniumFortress((data & 0x0008000000L) != 0)
                    .cityOfTheDamned((data & 0x0010000000L) != 0)
                    .riverOfFlame((data & 0x0020000000L) != 0)
                    .build());
            acts.act5().waypoints(br.com.yomigae.cloudstash.core.d2s.model.progress.Progress.Act5.Waypoints.builder()
        ...
        return new EnumMap<>(transformValues(all, D2S.Progress.Builder::build));
    }
